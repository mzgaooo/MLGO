...
files = {
    ...
    'pemsbay': ['PEMSBAY/PEMSBAY.npz', 'PEMSBAY/PEMSBAY.csv'],
    'metrla': ['METRLA/METRLA.npz', 'METRLA/METRLA.csv'],
}
...
def read_data(args):
    ...
    mean_value = np.mean(train_data, axis=(0, 1)).reshape(1, 1, -1)
    std_value = np.std(train_data, axis=(0, 1)).reshape(1, 1, -1)
